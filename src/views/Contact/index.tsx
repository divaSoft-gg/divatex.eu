import { LOCATION } from "../../common/data";
...
export default function Contact() {
  ...
  return (
    <div className="w-full bg-gray-100 ">
      ...
      <div className="max-w-[var(--max-content-width)] mx-auto pb-12 text-center px-4 lg:px-0">
        ...
        <div className="grid grid-cols-1 gap-3 mt-8 lg:grid-cols-3">
          {LOCATION.map((element: locationsProps, index: number) => (
            <div
              key={index}
              className="flex flex-col gap-10  rounded-md border dark:border-0 gap-4 p-6 bg-[#F8FAFC] dark:bg-[#161616]"
            >
